...
(function() {
  $(function() {
    var collapseMyMenu, expandMyMenu, hideMenuTexts, showMenuTexts,showmain,hidemain;
    ...
    hideMenuTexts = function() {
      ...
      showmain = function() {
          return $(".main").removeClass("menu-collapsed").addClass("menu-expanded");
      };
      hidemain = function() {
          return $(".main").removeClass("menu-expanded").addClass("menu-collapsed");
      };
